          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-base sm:text-lg md:text-xl max-w-3xl mx-auto px-4 leading-relaxed">
                ...
                explore the world. We believe that travel is more than just visiting
                new places – it's about experiencing different cultures, meeting new
                people, and creating lifelong memories.
              </p>
            ...
            <div className="mt-12 flex flex-col md:flex-row items-center gap-6 bg-gray-50 border border-gray-200 rounded-2xl p-6 hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="md:w-1/2">
                ...
                <p className="mt-6 text-base sm:text-lg md:text-xl leading-relaxed">
                  ...
                  between travel dreams and reality.
                </p>
              </div>
            </div>
                  ...
                  <ul className="list-disc pl-6 space-y-6">
                    <li>
                      ...
                      <p className="text-base sm:text-lg leading-relaxed">
                        ...
                        exploration, we'll help you create unforgettable experiences.
                      </p>
                    </li>
                    <li>
                      <strong className="text-xl sm:text-2xl">
                      ...
                      <p className="text-base sm:text-lg leading-relaxed">
                        Our goal is to help you create lifelong memories that you'll
                        cherish forever. From trying new foods to exploring hidden
                        gems, we'll make sure your travel experience is nothing short
                        of amazing.
                      </p>
                    </li>
                    <li>
                      ...
                      <p className="text-base sm:text-lg leading-relaxed">
                        We'll connect you with travel agents who have the expertise
                        and resources to make your travel planning process seamless
                        and enjoyable. No more endless research or tedious planning –
                    ...
                    <li>
                      ...
                      <p className="text-base sm:text-lg leading-relaxed">
                        ...
                        recommendations. Whether you're a seasoned traveler or just
                        starting to plan your next trip, we'll provide you with the
                        insights and ideas you need to make your travel dreams a
                        reality.
                      </p>
                    </li>
                  </ul>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="md:w-1/2 order-1 md:order-2">
                  ...
                  <ul className="list-disc pl-6 space-y-6 mt-6">
                    <li>
                      <strong className="text-xl sm:text-2xl">High-Quality Leads</strong>
                      <p className="text-base sm:text-lg leading-relaxed">
                        We provide travel agents with targeted leads that help grow
                        their business and increase their customer base. Our leads
                        are carefully curated to ensure they're relevant, interested,
                        and ready to book.
                      </p>
                    </li>
                    <li>
                      <strong className="text-xl sm:text-2xl">Efficient Solutions</strong>
                      <p className="text-base sm:text-lg leading-relaxed">
                    ...
                    <li>
                      ...
                      <p className="text-base sm:text-lg leading-relaxed">
                        ...
                        agents, providing them with the tools and resources they need
                        to succeed. Whether you're a small agency or a large tour
                        operator, we'll work with you to create a customized solution
                        that meets your unique needs.
                      </p>
                    </li>
                    <li>
                      <strong className="text-xl sm:text-2xl">Business Growth</strong>
                      <p className="text-base sm:text-lg leading-relaxed">
                        We'll help you grow your business and increase your revenue
                        through our targeted marketing campaigns and lead generation
                        services. Our goal is to help you succeed, and we'll work
                        tirelessly to ensure you get the results you need.
                      </p>
                    </li>
                  </ul>
                </div>
                ...
                <div className="md:w-1/2">
                  ...
                  <ul className="list-disc pl-6 space-y-6 mt-6">
                    <li>
                      ...
                      <p className="text-base sm:text-lg leading-relaxed">
                        We're dedicated to understanding your needs and preferences,
                        tailoring our services to meet your unique requirements.
                        Whether you're a traveler or a travel agent, we'll work with
                        you to create a personalized experience that exceeds your
                        expectations.
                      </p>
                    </li>
                    <li>
                      ...
                      <p className="text-base sm:text-lg leading-relaxed">
                        ...
                        planning experience. From mobile apps to AI-powered chatbots,
                        we'll always be at the forefront of innovation.
                      </p>
                    </li>
                    <li>
                      ...
                      <p className="text-base sm:text-lg leading-relaxed">
                        ...
                        building trust with our partners and travelers. We'll always
                        be upfront and honest about our services, fees, and policies.
                      </p>
                    </li>
                    <li>
                      <strong className="text-xl sm:text-2xl">Passion for Travel</strong>
                      <p className="text-base sm:text-lg leading-relaxed">
                        We're passionate about travel and committed to helping others
                        experience the joy of exploration. Whether you're a seasoned
                        traveler or just starting to plan your next trip, we'll share
            ...
            <div className="mt-12 bg-gray-50 border border-gray-200 rounded-2xl p-6 hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="mt-6 text-base sm:text-lg md:text-xl text-center max-w-3xl mx-auto leading-relaxed">
                Our ultimate goal is to make travel planning effortless and enjoyable
                for all. We envision a world where travelers can focus on creating
                memories, not stressing about logistics. By bridging the gap between
                travel dreams and reality, we aim to become the go-to partner for
                travel agents and travelers alike.
              </p>
            </div>
          </div>
        </section>
