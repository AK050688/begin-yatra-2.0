...
const AboutSection = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto z-10 px-4 md:px-8 py-16 gap-10 bg-gradient-to-b from-white to-gray-50">
      {/* Left Image */}
