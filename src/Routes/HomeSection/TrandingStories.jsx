...
const StoriesData = [
  {
    ...
    reviews: "Top 10 Things to do in Kashmir",
    Description:
  ...
  },
  {
    ...
    reviews: "Top 10 Things to do in Shimla",
    Description:
  ...
  },
  {
    ...
    reviews: "Top 10 Things to do in Dubai",
    Description:
  ...
  },
  {
    ...
    reviews: "Top 10 Things to do in Gangtok",
    Description:
            ...
            {StoriesData.map((data, index) => (
              ...
              >
                ...
                <div className="p-4 flex flex-col justify-start">
                  ...
                  <p className="pt-2 text-sm text-gray-600 text-justify line-clamp-3 ">{data.Description}</p>
