    ...
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 text-gray-800">
        ...
        <p className="text-sm text-center text-gray-600 mb-10">
          At <strong>BeginYatra</strong>, we prioritize the privacy and security
          of our users' information, including both travelers and travel agents.
        ...
        <section className="space-y-8 text-sm md:text-base leading-relaxed">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700">
              <li>
                <strong>Personal Data:</strong> We collect personal data, such
                as name, email address, phone number, and company information
                (for travel agents), when you register for our services or
                purchase a subscription.
              </li>
              <li>
                <strong>Usage Data:</strong> We collect information about your
                interactions with our Website and Services, including IP
                addresses, browser types, and pages visited.
              </li>
              <li>
                <strong>Travel Preferences:</strong> For travelers, we may
                collect information about your travel preferences, such as
                destinations and interests, to facilitate better services.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700">
              <li>
                ...
                provide our Services, including delivering travel leads to
                travel agents and connecting travelers with suitable travel
                options.
              </li>
              <li>
                <strong>Communication:</strong> We may contact you with updates,
                promotions, or important information related to our Services.
              </li>
              <li>
                <strong>Lead Generation:</strong> For travel agents, we use your
                information to deliver high-quality leads generated through our
                platform.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              assist us in providing our Services, such as lead delivery and
              customer support. We ensure these providers adhere to strict
