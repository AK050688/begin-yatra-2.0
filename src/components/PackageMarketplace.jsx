...
<section className="px-4 md:px-12 py-10 bg-white">
  <h1 className="text-2xl md:text-3xl text-black font-bold mb-6">
  ...
  <div className="flex flex-wrap gap-3">
    {placeByMonth.map((data, index) => (
      <span
        key={index}
        className="rounded-full border border-gray-300 py-6 px-6 text-sm hover:bg-[#3b82f6] hover:text-white text-black transition cursor-pointer"
      >
        {data}
      </span>
    ))}
    ...
    <div className="px-4 sm:px-8 md:px-12 py-8 bg-white">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8 text-center sm:text-left">
        <p className="text-2xl font-semibold text-black">We're a growing tour package marketplace</p>
