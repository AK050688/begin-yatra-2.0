...
import { FaEdit, FaEye, FaPlus, FaTimes, FaSearch, FaMapMarkerAlt } from 'react-icons/fa';
...
const Places = () => {
  ...
  return (
    <div className="p-2 sm:p-4 md:p-6 w-full">
      {/* Header with stats */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Places Management</h1>
        <div className="text-sm text-gray-600">
          Showing {places.length} of {totalPlaces} places (Page {page} of {totalPages})
        </div>
      </div>
                  ...
                  <div key={place._id} className="p-4 hover:bg-gray-50">
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="text-sm font-medium text-gray-900" title={place.placeName}>
                            {truncateText(place.placeName)}
                          </h3>
                          {needsTruncation(place.placeName) && (
                            <button
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm text-gray-500">{formatDate(place.createdAt)}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-2 text-sm mb-4">
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <p className="text-gray-900" title={place.placeDescription}>
                            {truncateText(place.placeDescription)}
                          </p>
                          {needsTruncation(place.placeDescription) && (
                            <button
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-900">{selectedPlace.placeDescription}</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{formatDate(selectedPlace.createdAt)}</p>
                </div>
              </div>
            </div>
