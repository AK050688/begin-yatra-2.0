...
const countries = [
  {
    ...
    description: 'Explore the cultural richness of Rajasthan, beaches of Goa, and the Himalayas.',
  },
  {
    name: 'France',
    image: '/Images/goa.jpeg',
    description: 'From the Eiffel Tower to the Riviera – discover romantic France.',
  },
  {
    name: 'Italy',
    image: '/Images/Andaman.jpg',
    description: 'Dive into history, art, and food in beautiful Italian cities.',
  },
  {
    name: 'Thailand',
    image: '/Images/rajastan.png',
  ...
  },
  {
    name: 'Australia',
    image: '/Images/goa.jpeg',
    description: 'Visit the land of kangaroos, beaches, and the Great Barrier Reef.',
  },
  {
    name: 'Switzerland',
    image: '/Images/Andaman.jpg',
          ...
          <div key={index} className="px-3">
            ...
            >
              ...
              <div className="absolute bottom-0 p-5 text-white w-full">
                ...
                <p className="text-sm text-gray-200 mt-1">{country.description}</p>
